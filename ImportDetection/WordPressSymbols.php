...
class WordPressSymbols {
	public static function getWordPressSymbolPatterns(): array {
		$strings = array_merge(
			[],
			self::getWordPressFunctions(),
			self::getWordPressConstants()
		);
		return array_map(function (string $functionName): string {
			return "^{$functionName}$";
		}, $strings);
	}

	private static function getWordPressFunctions(): array {
		// From: http://api.wpseek.com/?method=wordpress.getfunctions&output=plain
		$allFunctions = <<< ENDPATTERNS
_
__
__autoload
...
ENDPATTERNS;
	...
	private static function getWordPressConstants(): array {
		// from https://api.wpseek.com/1.1/wordpress/constants.json
		$allConstants = <<< ENDPATTERNS
ABSPATH
ADMIN_COOKIE_PATH
